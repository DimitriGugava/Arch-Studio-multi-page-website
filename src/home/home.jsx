      ...
      <div className="home_Page_Container">
        <div className="home_Page_See_Portfolio_Box">
          ...
          <div className="home_Page_See_Porftolio_Content">
            ...
            <Link
              className="home_Page_See_Porftolio_Content_Button"
              to="/portfolio"
            >
              See our Portfolio
              <img
        ...
        <div className="home_Page_Welcome">
          ...
          <span className="home_Page_Welcome_Small_Text">
            ...
            that inspire and delight. We work closely with our clients so that
            we understand the intricacies of each project. This allows us to
            work in harmony the surrounding area to create truly stunning
        ...
        <div className="main_Page_About_Us_Box">
          ...
          <Link className="main_Page_About_Us_Button" to="/aboutus">
